  ...
  switch (normalizedName) {
    ...
    case "MAX":
      return (
        ...
        >
          <defs>
            <linearGradient id="switch-b">
              <stop offset="0" stopColor="#00f" />
              <stop offset="1" stopOpacity="0" />
            </linearGradient>
            <linearGradient id="switch-a">
          ...
          <rect width="1000" height="1000" fill="url(#switch-c)" ry="249.681" />
          <rect width="1000" height="1000" fill="url(#switch-d)" ry="249.681" />
          <path
            fill="#fff"
            fillRule="evenodd"
    ...
    case "TELEGRAM":
      return (
        ...
        >
          ...
          <path
            id="path2991"
            fill="url(#switch-tgPaperGradient)"
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="border border-slate-200 rounded-3xl p-8 bg-white relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-8">
            <div className="border border-slate-200 p-5 rounded-2xl flex flex-col gap-3 h-fit bg-slate-50/30">
              ...
              <a
                ...
                className="w-full py-3 px-4 flex items-center justify-center gap-2 border border-slate-200 hover:border-slate-950 text-slate-700 hover:text-white hover:bg-slate-950 rounded-xl text-xs font-bold uppercase tracking-wider transition-all duration-150 ease-out active:bg-slate-800"
              >
                VK
                {getSocialIcon("VK")}
              </a>
            ...
            <div className="flex flex-col gap-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {currentData.plans.map((plan, idx) => (
                  <div
                    key={idx}
                    className="p-6 border border-slate-200 rounded-2xl bg-white flex flex-col shadow-sm hover:shadow-md transition-shadow duration-300"
                  >
              ...
              <div className="border-t border-slate-200 pt-6 text-center">
                ...
                <a
                  ...
                  className="font-black text-lg text-slate-850 hover:text-slate-950 hover:underline transition-colors"
                >
                  {currentData.phone}
                </a>
              </div>
